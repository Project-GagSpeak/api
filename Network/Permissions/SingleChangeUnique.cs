...
public record SingleChangeUnique(UserData Target, KeyValuePair<string, object> NewPerm, UpdateDir Direction, UserData Enactor) : UserDto(Target)
{
    public override string ToString() => "UniquePermChange: " +
