...
/// <summary>
///     Sends a set of LociStatusInfo tuples to the target kinkster for them to apply.
/// </summary>
[MessagePackObject(keyAsPropertyName: true)]
public record ApplyLociStatus(UserData User, IEnumerable<LociStatusInfo> Statuses, bool LockIds) : KinksterBase(User);
