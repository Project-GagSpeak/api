...
/// <summary>
///     Callback informing a Collar's data was updated for a specific <paramref name="User"/>.
///     The <paramref name="LightItem"/> holds the new data for the collar. <para />
///     
///     If null, the callback implies this Item should be removed from the kinkster cache.
/// </summary>
[MessagePackObject(keyAsPropertyName: true)]
public record KinksterNewCollarData(UserData User, LightCollar? LightItem) : KinksterBase(User);
