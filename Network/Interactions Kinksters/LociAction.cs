...
public record ApplyLociDataById(UserData User, IEnumerable<Guid> Ids, bool IsPresets, bool LockIds) : UserDto(User);

/// <summary>
///   Sends a set of LociStatusStruct tuples to the target kinkster for them to apply.
/// </summary>
[MessagePackObject(keyAsPropertyName: true)]
public record ApplyLociStatus(UserData User, IEnumerable<LociStatusStruct> Statuses, bool LockIds) : UserDto(User);
