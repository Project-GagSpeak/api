...
//public record CreateKinksterRequest(UserData User, bool IsTemp, string PreferredNick, string Message) : UserDto(User);
...
///// </summary>
//[MessagePackObject(keyAsPropertyName: true)]
//public record AcceptCollarRequest(UserData User, LightCollar? ChosenCollar = null) : UserDto(User);