...
/// </summary>
public static class AppearanceDataEx
{
    ...
    public static bool IsGagged(this CharaAppearanceData gagData) => gagData.GagSlots.Any(x => x.GagType != GagType.None.GagName());
    ...
    public static int TotalGagsEquipped(this CharaAppearanceData gagData) => gagData.GagSlots.Count(x => x.GagType != GagType.None.GagName());
    ...
    public static bool AnyGagActive(this CharaAppearanceData gagData) => gagData.GagSlots.Any(x => x.GagType != GagType.None.GagName());
    ...
    public static bool AnyGagLocked(this CharaAppearanceData gagData) => gagData.GagSlots.Any(x => x.Padlock != Padlocks.None.ToName());
    ...
    public static List<string> CurrentGagNames(this CharaAppearanceData gagData) => gagData.GagSlots.Select(gag => gag.GagType).ToList();
    ...
    public static List<string> ActiveGagTrackingKeys(this CharaAppearanceData gagData)
    {
    ...
    public static int FindFirstUnused(this CharaAppearanceData gagData)
    {
    ...
    public static int FindOutermostActive(this CharaAppearanceData gagData)
    {
    ...
    public static int FindOutermostActive(this CharaAppearanceData gagData, GagType match)
    {
        for (var i = gagData.GagSlots.Length - 1; i >= 0; i--)
        {
