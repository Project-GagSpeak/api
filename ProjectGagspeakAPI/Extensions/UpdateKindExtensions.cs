...
public static class UpdateKindExtensions
{
    ...
    => kind switch
    {
        ...
        DataUpdateKind.WardrobeRestraintOutfitsUpdated => "Restraint Outfits Updated",
        ...
        DataUpdateKind.ToyboxPatternListUpdated => "Toybox Pattern List Updated",
        DataUpdateKind.ToyboxPatternExecuted => "Toybox Pattern Executed",
        DataUpdateKind.ToyboxPatternStopped => "Toybox Pattern Stopped",
        DataUpdateKind.ToyboxAlarmListUpdated => "Toybox Alarm List Updated",
        DataUpdateKind.ToyboxAlarmToggled => "Toybox Alarm Toggled",
        DataUpdateKind.ToyboxTriggerListUpdated => "Toybox Trigger List Updated",
        DataUpdateKind.ToyboxTriggerToggled => "Toybox Trigger Toggled",
        DataUpdateKind.PiShockGlobalUpdated => "PiShock Global Updated",
        DataUpdateKind.PiShockOwnPermsForPairUpdated => "PiShock Own Perms For Pair Updated",
        DataUpdateKind.PiShockPairPermsForUserUpdated => "PiShock Pair Perms For User Updated",
