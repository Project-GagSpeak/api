...
/// <summary>
///     The updated IPC Data of a spesified <paramref name="User"/>.
/// </summary>
...
public record KinksterUpdateIpc(UserData User, UserData Enactor, CharaIPCData NewData, DataUpdateType Type) : KinksterBase(User);
