...
public static class Constants
{
    ...
    public const string FolderTagPuppeteers         = "Your Puppeteers";
    public const string FolderTagNonPuppeteers      = "Other Kinksters";
    public const string FolderTagAliasesActive      = "Active Aliases";
    public const string FolderTagAliasesInactive    = "Inactive Aliases";
