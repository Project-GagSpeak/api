...
{
    None            = 0 << 0, // No Access
    AllowOwn        = 1 << 0, // The Access Owners own locis can be applied.
    AllowOther      = 1 << 1, // The Access Owners 'other' / 'pair' can apply their locis.
    ...
    Permanent       = 1 << 5, // Locis without a duration can be applied.
    RemoveApplied   = 1 << 6, // 'Other' can remove only locis they have applied.
    RemoveAny       = 1 << 7, // 'Other' can remove any locis.
    Clearing        = 1 << 8, // 'Other' can clear all locis.
}
